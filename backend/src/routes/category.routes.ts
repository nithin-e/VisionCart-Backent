...
router.get('/admin/categories/:id', adminAuthMiddleware, (req, res, next) => categoryController.getById(req as any, res, next));
router.post('/admin/categories', adminAuthMiddleware, (req, res, next) => categoryController.create(req, res, next));
router.put('/admin/categories/:id', adminAuthMiddleware, (req, res, next) => categoryController.update(req as any, res, next));
router.delete('/admin/categories/:id', adminAuthMiddleware, (req, res, next) => categoryController.delete(req as any, res, next));
