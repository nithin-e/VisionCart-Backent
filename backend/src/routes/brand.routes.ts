...
router.get('/admin/brands/:id', adminAuthMiddleware, (req, res, next) => brandController.getById(req, res, next));
router.post('/admin/brands', adminAuthMiddleware, (req, res, next) => brandController.create(req, res, next));
router.put('/admin/brands/:id', adminAuthMiddleware, (req, res, next) => brandController.update(req, res, next));
router.delete('/admin/brands/:id', adminAuthMiddleware, (req, res, next) => brandController.delete(req, res, next));
