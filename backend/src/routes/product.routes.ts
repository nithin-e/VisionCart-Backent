...
router.get('/admin/products/:id', adminAuthMiddleware, (req, res, next) => productController.getById(req as any, res, next));
router.post('/admin/products', adminAuthMiddleware, (req, res, next) => productController.create(req, res, next));
router.put('/admin/products/:id', adminAuthMiddleware, (req, res, next) => productController.update(req as any, res, next));
router.delete('/admin/products/:id', adminAuthMiddleware, (req, res, next) => productController.delete(req as any, res, next));
